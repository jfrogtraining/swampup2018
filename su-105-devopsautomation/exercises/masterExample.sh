...
step3-create-docker-image-product () {
  ...
  cd swampup2018/su-105-devopsautomation/exercises/step3_dockerapp
  echo "Downloading dependencies"
  downloadDependenciesTools
  ...
  echo "Collecting environment variable for buildinfo"
  ./jfrog rt bce step3-create-docker-image-product $1
  echo  "publishing buildinfo"
  ./jfrog rt bp step3-create-docker-image-product $1 --server-id=${SERVER_ID}
  docker rmi $TAGNAME
